...
We have a great deal of debate on that topic.
版本二：that改为this  
版本三：We have 改成 There is
...
When attending a job interview, punctuality is the key.
...
版本二：a改成the  
版本三：Tutorials / are scheduled / in the final week / of the term.

One student representative will be selected from each class.
版本二：One student / will be selected / as a representative / for each class.
